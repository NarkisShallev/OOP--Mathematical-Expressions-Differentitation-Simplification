    ...
    public Expression advancedSimplify() {
        if (this.getE1() instanceof Mult && this.getE2() instanceof Mult) {
            ...
            if (((Mult) this.getE1()).getE2().toString().equals(((Mult) this.getE2()).getE2().toString())
                    && ((Mult) this.getE1()).getE1() instanceof Num && ((Mult) this.getE2()).getE1() instanceof Num) {
                try {
                ...
                // ((2x) + (x4)) => 6*x
                    ...
                    && ((Mult) this.getE1()).getE1() instanceof Num && ((Mult) this.getE2()).getE2() instanceof Num) {
                try {
                ...
                // ((x2) + (4x)) => 6*x
                    ...
                    && ((Mult) this.getE1()).getE2() instanceof Num && ((Mult) this.getE2()).getE1() instanceof Num) {
                try {
                ...
                // ((x2) + (x4)) => 6*x
                    ...
                    && ((Mult) this.getE1()).getE2() instanceof Num && ((Mult) this.getE2()).getE2() instanceof Num) {
                try {
            ...
            return new Mult(new Num(2), this.getE1()).simplify().advancedSimplify();
            ...
            return new Mult(new Plus(((Mult) this.getE1()).getE1(), new Num(1)), this.getE2()).simplify().
                    advancedSimplify();
            ...
            return new Mult(new Plus(((Mult) this.getE2()).getE1(), new Num(1)), this.getE1()).simplify().
                    advancedSimplify();
        }
